                ...
                <div class="row">
                    <div class="col-md-6">
                        <div style="overflow: hidden; position: relative;">
                            <li style="width: 471px; margin-right: 0px; float: left; display: block;">
                                <img style="height: 300px;" src="{{ $data[0]->hinh_anh }}" alt="Image" draggable="false">
                                <div class="flat-icon style-2">
                                    <a href="https://www.youtube.com/watch?v=LQpedLhpQsk" class="popup-video"><span
                                            class="fa fa-play"></span><span style="background: rgba(146, 56, 42, 0.533);"
                                            class="text text-info">Xem Hướng Dẫn</span></a>
                                </div>
                            </li>
                        </div>
                    </div><!-- /.col-md-6 -->
                            ...
                            <div class="inner">
                                <div class="content-detail">
                                    ...
                                    <ul class="product-infor style-1">
                                        ...
                                        @endforeach
                                        <li><span>Link Tải : <a href="{{ $data[0]->link1 }}"><i
                                    ...
                                    <form id="formdata" v-on:submit.prevent="checkout()">
                                        <div class="product-quantity margin-top-35">
                                                    ...
                                                    @foreach ($data as $value)
                                                        @if (!in_array($value->thoi_gian, $check))
                                                            <option value="{{ $value->id_pack }}">
                                                                {{ $value->gia_ban }}đ/{{ $value->thoi_gian }} Giờ
                                                            </option>
                                                            @php
                                            ...
                                            {{-- <div class="box-like">
                                                <a href="{{ $data[0]->link1 }}" class="like"><i
                ...
                <div class="row">
                    <div class="comments-section mt-100 home-section overflow-hidden">
                        ...
                        <div class="comments-area" v-if="listDanhGia.length>0">
                            <div v-for="(v,k) in listDanhGia" class="d-flex comments-item mt-4">
